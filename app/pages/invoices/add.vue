  ...
  <div class="bg-black text-gray-200 p-4 sm:p-8">
    <div class="max-w-6xl mx-auto">
      <div class="mb-8 flex justify-between items-end">
        <h1 class="text-3xl font-bold text-green-500 tracking-tight">New Invoice</h1>
        <div class="text-right">
          <p class="text-sm text-gray-500 uppercase font-semibold tracking-wider">Grand Total</p>
          ...
          <div class="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-4">
            ...
            <div class="space-y-3 pt-2">
              <button type="submit" :disabled="isSubmitting"
                class="w-full py-4 bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl shadow-lg transition-all active:scale-[0.98] disabled:opacity-50 uppercase tracking-widest">
